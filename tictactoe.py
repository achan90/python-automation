...
return ((bo[7] == le and bo[8] == le and bo[9] == le) or  # across the top
  ...
  (bo[4] == le and bo[5] == le and bo[6] == le) or
    ...
    (bo[7] == le and bo[5] == le and bo[3] == le) or  # diagonal
     (bo[9] == le and bo[5] == le and bo[1] == le))  # diagonal6.
...
# Try to take one of the corners, if they are free.2.     move =
...
return 5
 ...
 return chooseRandomMoveFromList(board, [2, 4, 6, 8])3.
 ...
 print('Welcome to Tic Tac Toe!')4.
 while True:
     # Reset the board
     theBoard = [' '] * 10
...
if isWinner(theBoard, playerLetter):
 ...
 break
    ...
    # Computer’s turn.7.             move = getComputerMove(theBoard,
    # computerLetter)
...
if isWinner(theBoard, computerLetter):
 ...
 if isBoardFull(theBoard):
                     drawBoard(theBoard)8. print('The game is a tie!')
 break
 else:
                     turn = 'player'
